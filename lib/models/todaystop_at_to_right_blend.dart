...
class TodaystopAtToRightBlend {
  ...
  TodaystopAtToRightBlend({this.items, this.limit, this.next, this.offset, this.previous, this.total});

  TodaystopAtToRightBlend.fromJson(Map<String, dynamic> json) {
